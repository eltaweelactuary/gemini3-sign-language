...
APP_ROOT = os.path.dirname(SCRIPT_DIR).replace("\\", "/") # Root of hackathon folder
...
def main():
    ...
    with tab1:
        ...
        if 'benchmark_path' in st.session_state:
            ...
            with char_col2:
                avatar_options = {
                    "🎬 Konecta Elite (Studio)": os.path.join(SCRIPT_DIR, "VRM1_Constraint_Twist_Sample.vrm"),
                    "🤖 Konecta Neo (Standard)": os.path.join(SCRIPT_DIR, "5084648674725325209.vrm"),
                    "🌟 Konecta Prime (High-Fidelity)": os.path.join(SCRIPT_DIR, "4152045953412205614.vrm")
                }
